...
fn main() {
    ...
    // println!("go to {:#08x}, please", 1.green().link("https://google.com").italic());
    // //
    ...
    //
    // println!("> Formatting hello.");
    // let x = "x".blue().to_string();
    // let foo = format!("Hello {:->10}!", x.green().on_primary().italic().invert().wrap());
    // println!("<");
    // println!("> formatting warning...");
    // let msg = format!("Warning: please see {} for more.", foo);
    // println!("< > msg.yellow().wrap()");
    // println!("{}", msg.yellow().wrap());
    // println!("< > msg.yellow().wrap().to_string()");
    // println!("{:?}", msg.yellow().wrap().to_string());
    // println!("< > regular");
    // println!("{:+#08x}", 100);
    // println!("<");
    //
    // println!("{}", "Regular".black());
    // println!("{}", "Bright".bright_black());
    // println!("{}", "Bright".black().bright());
    // println!("{}", "Bright".bright().black());
    // println!("{}", "Regular".red());
    // println!("{}", "Bright".bright_red());
    // println!("{}", "Bright".bright().red());
    //
    // static STYLE: yansi::Style = yansi::Color::Green.bold();
    // println!("{}", "Bright".paint(STYLE).bright());
}
