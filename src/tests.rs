...
fn colors_enabled() {
    assert_renders! {
        ...
        Paint::purple("hi").bg(White) => "\x1B[47;35mhi\x1B[0m",
        ...
        Paint::fixed(100, "hi").bg(Purple) => "\x1B[45;38;5;100mhi\x1B[0m",
...
fn colors_disabled() {
    assert_disabled_renders! {
        ...
        Paint::fixed(100, "hi").bg(Purple) => "hi",
